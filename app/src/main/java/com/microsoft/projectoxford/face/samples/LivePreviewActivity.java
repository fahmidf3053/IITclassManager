...
public final class LivePreviewActivity extends AppCompatActivity
  ...
  public void onDestroy() {
    ...
    if(faceDetectionProcessor.detectTask!=null){
      faceDetectionProcessor.detectTask.cancel(true);
    }
    if(faceDetectionProcessor.identifyTask!=null){
      faceDetectionProcessor.identifyTask.cancel(true);
    }
  }
